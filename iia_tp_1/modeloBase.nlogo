...
turtles-own [energia lixo ticksEspera coordsCarregador knowsLixo]
...
@#$#@#$#@
<experiments>
  <experiment name="experiencia10" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="experiencia11" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia12" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia20" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia21" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia22" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia30" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia31" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
  ...
  <experiment name="experiencia32" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <exitCondition>ticks &gt;= 500</exitCondition>
    <metric>count patches with [pcolor = red]</metric>
